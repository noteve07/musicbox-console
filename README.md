This is from my OOP Lab Exercise 2. Here, I experimented with console-based application with audio playback and interactive interface using ASCII and Unicode characters.
